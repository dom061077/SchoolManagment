...
create sequence turno_seq start with 1 increment by 50;
create table curso_division (curso_id bigint not null, division_id bigint not null, primary key (curso_id, division_id));
create table curso_turno (curso_id bigint not null, turno_id bigint not null, primary key (curso_id, turno_id));
create table division (id bigint not null, name varchar(255) not null, primary key (id));
...
create table curso_division (curso_id bigint not null, division_id bigint not null, primary key (curso_id, division_id));
create table curso_turno (curso_id bigint not null, turno_id bigint not null, primary key (curso_id, turno_id));
alter table if exists division add column name varchar(255) not null;
create table inscripcion_alumno (id bigint not null, created_by varchar(255), created_date timestamp(6), deleted boolean not null, last_modified_by varchar(255), last_modified_date timestamp(6), academic_period_id bigint, grade_level_id bigint, section_id bigint, shift_id bigint, student_id bigint, primary key (id));
create table nivel_grado (id bigint not null, grade integer not null, primary key (id));
create table periodo_lectivo (id bigint not null, created_by varchar(255), created_date timestamp(6), deleted boolean not null, last_modified_by varchar(255), last_modified_date timestamp(6), is_active boolean not null, year integer not null, primary key (id));
create table turno (id bigint not null, name varchar(255), primary key (id));
create sequence inscripcion_alumno_seq start with 1 increment by 50;
create sequence nivel_grado_seq start with 1 increment by 50;
create sequence periodo_lectivo_seq start with 1 increment by 50;
